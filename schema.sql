-- Kadal Thunai schema for Supabase Postgres
-- Mirrors the runtime bootstrap in src/lib/server/database.ts
...
CREATE UNIQUE INDEX IF NOT EXISTS ux_orders_razorpay_payment_id ON orders(razorpay_payment_id) WHERE razorpay_payment_id IS NOT NULL;
