...
import { User, CustomerStats, SERVER_API_URL, CUSTOMER_TAGS, LOYALTY_TIERS, USER_ROLES } from '@/types';
import { ApiStatus } from '@/components/dashboard/api-status';

const customerTags = CUSTOMER_TAGS;
const loyaltyTiers = LOYALTY_TIERS;
...
export default function UsersPage() {
  ...
  return (
    ...
    >
      ...
      <ApiStatus endpoint="users" onRefresh={fetchUsers} />
      ...
      {stats && (
        <motion.div 
          ...
          className="grid gap-4 md:gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-5"
        >
