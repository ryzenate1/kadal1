...
router.post('/', auth_1.authenticate, auth_1.isAdmin, (req, res) => {
    try {
        ...
        // Set defaults
        const fishWithDefaults = Object.assign(Object.assign({}, newFish), { featured: newFish.featured !== false, isActive: newFish.isActive !== false, price: Number(newFish.price) || 999, discount: Number(newFish.discount) || 0, iconName: newFish.iconName || 'Fish' });
...
router.put('/:id', auth_1.authenticate, auth_1.isAdmin, (req, res) => {
    try {
        ...
        // Update the fish
        featuredFish[fishIndex] = Object.assign(Object.assign(Object.assign({}, featuredFish[fishIndex]), updatedData), { id, price: Number(updatedData.price) || featuredFish[fishIndex].price, discount: Number(updatedData.discount) || featuredFish[fishIndex].discount });
