...
router.post('/', auth_1.authenticate, auth_1.isAdmin, (req, res) => {
    try {
        console.log('Creating new fish pick:', JSON.stringify(req.body, null, 2));
        const { name, image, category, price, originalPrice, weight, freshness, iconName, color, rating, description, isActive = true } = req.body;
        ...
        const newFishPick = {
            ...
            weight: (weight === null || weight === void 0 ? void 0 : weight.trim()) || '500g',
            freshness: (freshness === null || freshness === void 0 ? void 0 : freshness.trim()) || 'Fresh Today',
...
router.put('/:id', auth_1.authenticate, auth_1.isAdmin, (req, res) => {
    var _a, _b, _c, _d, _e;
    try {
        const { id } = req.params;
        ...
        const { name, image, category, price, originalPrice, weight, freshness, iconName, color, rating, description, isActive } = req.body;
        ...
        // Update fish pick
        const updatedFishPick = Object.assign(Object.assign({}, currentFishPick), { name: (_a = name === null || name === void 0 ? void 0 : name.trim()) !== null && _a !== void 0 ? _a : currentFishPick.name, image: image !== null && image !== void 0 ? image : currentFishPick.image, category: (_b = category === null || category === void 0 ? void 0 : category.trim()) !== null && _b !== void 0 ? _b : currentFishPick.category, price: price !== undefined ? Number(price) : currentFishPick.price, originalPrice: originalPrice !== undefined ? Number(originalPrice) : currentFishPick.originalPrice, weight: (_c = weight === null || weight === void 0 ? void 0 : weight.trim()) !== null && _c !== void 0 ? _c : currentFishPick.weight, freshness: (_d = freshness === null || freshness === void 0 ? void 0 : freshness.trim()) !== null && _d !== void 0 ? _d : currentFishPick.freshness, iconName: iconName !== null && iconName !== void 0 ? iconName : currentFishPick.iconName, color: color !== null && color !== void 0 ? color : currentFishPick.color, rating: rating !== undefined ? Number(rating) : currentFishPick.rating, description: (_e = description === null || description === void 0 ? void 0 : description.trim()) !== null && _e !== void 0 ? _e : currentFishPick.description, isActive: isActive !== undefined ? Boolean(isActive) : currentFishPick.isActive, updatedAt: new Date().toISOString() });
...
router.delete('/:id', auth_1.authenticate, auth_1.isAdmin, (req, res) => {
    try {
        const { id } = req.params;
